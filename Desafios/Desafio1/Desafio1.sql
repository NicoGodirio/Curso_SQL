...
(0, "Juan", "Perez", "Calle falsa 123", "41519812", "juan@gmail.com"),
(0, "Tito", "Lopez", "Calle verdadera 123", "41116822", "tito@gmail.com"),
(0, "Zoe", "Gomez", "Lujan 123", "11625612", "zoe@gmail.com");
...
-- Examinar datos
SELECT * FROM autores ORDER BY autor_id ASC;
SELECT * FROM editoriales ORDER BY editorial_id ASC; 
SELECT * FROM empleados ORDER BY puesto_id ASC, editorial_id ASC;
...
SELECT * FROM autores ORDER BY autor_id ASC;
INSERT INTO autores VALUES
	("341-22-1783", 'Lopez', 'Tito', 41231552, '', 'La Plata', 'BA', 1421, 1),
    ("341-22-1784", 'Gomez', 'Hernan', 23173552, '', 'Mina Clavero', 'CO', 2131, 0),
    ("341-22-1785", 'Rodriguez', 'Juliana', 71356552, '', 'Santa Rosa', 'LP', 1121, 1);
    
DESCRIBE editoriales;
SELECT * FROM editoriales;
INSERT INTO editoriales VALUES
	('9902', 'Tablarin', 'Cordoba', 'CO', 'Argentina'),
    ('9903', 'Sillin', 'Formosa', 'FO', 'Argentina'),
    ('9904', 'Recuadrin', 'Chaco', 'CH', 'Argentina');
    
DESCRIBE empleados;
SELECT * FROM empleados ORDER BY editorial_id ASC;
INSERT INTO empleados VALUES
	('B-R99958G', "Penelope", "Garcia", 5, 9903, curtime()),
    ('C-T13458G', "Julian", "Benitez", 4, 9903, curtime()),
    ('D-Y12558G', "Pirulo", "Sanchez", 2, 9903, curtime());

DESCRIBE libros;
SELECT * FROM libros;
INSERT INTO libros VALUES
	('BU1113', "Las crónicas de Narnia", "Fantasía", 9903, 25.00, '', curtime()),
    ('BU1114', "La leyenda de Pirulo", "Ciencia Ficción", 9903, 29.99, '', curtime()),
    ('BU1115', "La tragedia de la ballena", "Novelas", 9903, 16.70, '', curtime());
...
SELECT * FROM locales;
INSERT INTO locales VALUES
	('7001', "Librería Manantial", "Calle falsa 123","Cordoba", 'CO', '12456'),
    ('7002', "Librería Rogelio", "Avenida siempre viva 2910", "Santiago del Estero", 'SE', '13931'),
    ('7003', "Librería Hojas Felices","Abbey Road 9090", "Chubut", 'CT', '99365');
...
SELECT * FROM ventas;
INSERT INTO ventas VALUES
	('7001', "101", curtime(), 3, "Transf", "BU1114"),
    ('7002', "520", curtime(), 2, "Efectivo", "BU1115"),
    ('7003', "4", curtime(), 1, "Efectivo", "BU1116");       
